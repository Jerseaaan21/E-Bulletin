...
// Fetch department posts using main_post table, ordered by order_position
$query = "SELECT * FROM main_post WHERE module = ? ORDER BY order_position ASC, id ASC";
    ...
    function initializeAboutModule() {
        ...
        if (addPostForm) {
            addPostForm.addEventListener('submit', function(e) {
                ...
                fetch('CEIT_Modules/About/save_post.php', {
                        method: 'POST',
                        headers: {
