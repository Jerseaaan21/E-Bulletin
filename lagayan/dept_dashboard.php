...
<body class="bg-gray-50 min-h-screen font-sans">
    ...
    <script>
        ...
        function showNotification(message, type = 'success') {
            ...
            notification.className = `fixed top-4 right-4 z-50 bg-${type === 'success' ? 'green' : 'red'}-500 text-white px-4 py-3 rounded-lg shadow-lg mb-2`;
                ...
                switch (tabId) {
                    ...
                    default:
                        ...
                        if (tabId.startsWith('upload-module-')) {
                            const moduleId = tabId.replace('upload-module-', '');
                            const module = departmentData?.modules?.find(m => m.id == moduleId);
                            pageTitle.textContent = module ? module.name : 'Module';
