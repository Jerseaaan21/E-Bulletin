...
// Synchronized carousel functionality for Memo and Student Development
function synchronizedMemoStudentDevChange(direction) {
  // Change memo carousel
  ...
  // Change student development carousel
  ...
  // Get current indices
  let memoIndex = parseInt(memoViewer.dataset.currentIndex || '0');
  ...
  // Update the viewers
  updateCarouselItem('memos', memoIndex);
  updateCarouselItem('student-dev', studentDevIndex);
  
  // Store new indices
  memoViewer.dataset.currentIndex = memoIndex;
