...
// Fetch announcements data for JavaScript - now using iframe
$announcements = [];
...
<body class="bg-orange-500 p-2 font-sans h-full flex flex-col">
                ...
                <div class="h-full flex items-center justify-center bg-gray-100 responsive-bg" style="background-image: url('images/bg-small.png');">
                  <div class="carousel-text p-2 sm:p-3" style="margin: 5px 10px; background-color: rgba(240, 240, 240, 0.8); border-radius: 6px; line-height: 1.5;">
                    ...
                    <div style="text-align: left; font-size: 8px">
                      • Provide quality instruction in information technology<br>
                      • Conduct relevant research and development activities<br>
                      • Establish strong linkages with industries and communities<br>
                      • Produce globally competitive IT professionals
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="h-full flex items-center justify-center bg-gray-100 responsive-bg" style="background-image: url('images/bg-small.png');">
                  <div class="carousel-text p-2 sm:p-3" style="margin: 5px 10px; background-color: rgba(240, 240, 240, 0.8); border-radius: 6px; line-height: 1.5;">
                    ...
                    <div style="text-align: left;">
                      The Department of Information Technology is committed to providing quality education in the field of Information Technology. It offers programs that are designed to equip students with the necessary knowledge and skills to become competent IT professionals.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="tab-container">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="announcements-tab">
              <iframe src="Modules/Announcements/AnnouncementBulletin.php" 
  ...
  <div id="page2" class="page">
    <main class="grid grid-cols-1 lg:grid-cols-2 gap-2 p-1 font-bold text-center flex-grow page2-grid">
      ...
      <div class="rounded-lg shadow-md p-2 sm:p-4 transition duration-500 transform hover:scale-[1.02] relative overflow-hidden" style="background-image: url('images/ditorg.jpg'); background-size: 100% 100%; background-position: center; background-repeat: no-repeat;">
        ...
        <div class="relative z-10">
          ...
          <div class="content-area">
            ...
            <div class="bg-white bg-opacity-90 p-4 rounded-lg h-full flex items-center justify-center">
              <div class="text-center">
                <i class="fas fa-sitemap text-gray-400 text-5xl mb-4"></i>
                <p class="text-gray-600">Organizational Structure</p>
                <p class="text-gray-500 text-sm mt-2">Org chart would be displayed here</p>
              </div>
            </div>
          </div>
        </div>
...
<script src="https://cdn.jsdelivr.net/npm/chartjs-plugin-datalabels@2"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.10.377/pdf.min.js"></script>
<script src="dept_bulletin.js"></script>
