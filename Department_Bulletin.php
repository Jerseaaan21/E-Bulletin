...
<body class="bg-orange-500 p-2 font-sans h-full flex flex-col">
  ...
  <div id="page2" class="page">
    <main class="grid grid-cols-1 lg:grid-cols-2 gap-2 p-1 font-bold text-center flex-grow page2-grid">
      ...
      <div class="rounded-lg shadow-md p-2 sm:p-4 transition duration-500 transform hover:scale-[1.02] relative overflow-hidden bg-white">
        <div class="relative z-10">
          ...
          <div class="content-area">
            ...
            <div class="bg-white p-2 rounded-lg h-full overflow-auto">
              <?php include 'Modules/Organizational_Chart/ViewChart.php'; ?>
            </div>
          </div>
        </div>
      </div>
