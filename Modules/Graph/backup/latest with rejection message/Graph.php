            ...
            <div id="group-upload-content" class="hidden">
                ...
                <div id="group-upload-step-1" class="upload-step">
                    <div class="mb-4">
                        ...
                        <input type="text" id="group-title" class="w-full p-3 border border-gray-300 rounded-lg" placeholder="Enter group title" onchange="checkGroupInputs()" oninput="checkGroupInputs()">
                    </div>
    ...
    <script>
        ...
        function initializeUploadModal() {
            ...
            if (cancelBtn) {
                ...
                const newCancelBtn = document.getElementById('upload-cancel-btn');
                ...
                inputsHTML += `
                    <div class="border border-gray-300 rounded-lg p-4 bg-gray-50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Graph Title</label>
                                <input type="text" id="group-graph-title-${i}" class="w-full p-2 border border-gray-300 rounded" placeholder="Enter graph ${i} title" onchange="checkGroupInputs()" oninput="checkGroupInputs()">
                            </div>
                            <div>
