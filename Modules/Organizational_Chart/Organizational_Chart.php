...
function showBox($member, $position_code, $isFaculty = false)
{
    ...
    if (isset($_SESSION['dept_id'])) {
        ...
        // Departments (DIT, DITT, etc.) are under the college
...
<script>
    ...
    const deptAcronym = '<?php echo htmlspecialchars($deptAcronym); ?>';
    const collegeAcronym = '<?php echo htmlspecialchars($collegeAcronym); ?>';
    const defaultRoles = {
        'president': 'President, CvSU',
        'vice_president': 'Vice President, OVPAA',
        'college_dean': 'Dean, ' + collegeAcronym,
