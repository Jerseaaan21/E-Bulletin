<?php
// Modules/Announcements/delete_announcement.php
session_start();
include "../../db.php";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Get the announcement details before deleting
    ...
    if ($result->num_rows > 0) {
        ...
        if (strpos($filePath, 'archive/') === 0) {
            ...
            $fileToDelete = "../../uploads/{$dept_acronym}/Announcement/archive/" . $fileName;
            ...
            $fileToDelete = "../../uploads/{$dept_acronym}/Announcement/" . $filePath;
